...
export default function CTA() {
  return (
    <section className="bg-gradient-to-r from-[#111832] via-[#1e293b] to-[#111832] py-stack-gap-lg relative overflow-hidden border-y border-white/5">
      {/* Glow effects */}
      ...
      <div className="max-w-container-max mx-auto px-gutter text-center relative z-10">
        ...
        <button className="bg-gradient-to-r from-[#6366f1] to-primary text-white px-10 py-4 rounded-full font-label-sm text-label-sm hover:scale-105 transition-transform active:scale-95 duration-200 cursor-pointer shadow-[0_0_30px_rgba(0,210,255,0.4)]">
          Let&apos;s collaborate
        </button>
      </div>
    </section>
